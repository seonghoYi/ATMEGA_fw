...
{
	{GPIOG, PIN2, _DEF_OUTPUT, PIN_RESET, PIN_SET}, // _PIN_GPIO_A4988_EN
	{GPIOG, PIN0, _DEF_OUTPUT, PIN_SET, PIN_RESET}, // _PIN_GPIO_A4988_LDIR
	{GPIOG, PIN1, _DEF_OUTPUT, PIN_SET, PIN_RESET}, // _PIN_GPIO_A4988_RDIR		
	{GPIOB, PIN4, _DEF_OUTPUT, PIN_SET, PIN_RESET}, //OC0
	{GPIOB, PIN7, _DEF_OUTPUT, PIN_SET, PIN_RESET}, //OC2
	{GPIOA, PIN0, _DEF_OUTPUT, PIN_SET, PIN_RESET}, //LED
};
